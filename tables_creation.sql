...
CREATE TABLE DeliveryProduct ( id INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, name VARCHAR(50), description VARCHAR(140), PRICE FLOAT, amount INT, deliveryOrder_id INT UNSIGNED );
CREATE TABLE DeliveryOrder ( id INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, destin_address VARCHAR(50), origin_address VARCHAR(50) );
